                        ...
                        <div class="modal fade" id="create" data-bs-backdrop="static" tabindex="-1">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form action="{{ url('create-data-mapel') }}" method="post">
                                        @method('post')
                                        @csrf
                                        <div class="modal-body">
                                            <div class="pt-2">
                                                ...
                                                <input type="text"
                                                    class="form-control @error('name') is-invalid @enderror" name="mapel"
                                                    id="mapel" placeholder="Masukan Nama Mapel">
                                                @error('mapel')
                            ...
                            <div class="modal fade" id="delete-{{ $item->id }}" tabindex="-1">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ url('delete-data-mapel/' . $item->id) }}" method="post">
                                            @method('DELETE')
                                            @csrf
                                            <div class="modal-body">
                                                Hapus {{ $pagetitle }} <b>{{ $item->mapel }}</b>?
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary"
                                                    data-bs-dismiss="modal">Tutup</button>
                            ...
                            <div class="modal fade" id="edit-{{ $item->id }}" tabindex="-1">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ url('update-data-mapel/' . $item->id) }}" method="post">
                                            @method('put')
                                            @csrf
                                            <div class="modal-body">
                                                <div class="pt-2">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        name="mapel" id="mapel" value="{{ $item->mapel }}"
