                                    ...
                                    <form action="{{ url('proses_login') }}" method="POST" class="row g-3 needs-validation"
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="input-group has-validation">
                                                ...
                                                <input type="text" name="username" class="form-control" placeholder="Masukan username" id="yourUsername"
                                                    required>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="password" name="password" class="form-control" placeholder="Masukan password" id="yourPassword"
                                                required>
                                        ...
                                        <div class="col-12">
                                            <label class="form-label">Belum punya akun? <a href=""><b>Daftar</b></a></label>
                                        </div>
                                    </form>
