                            ...
                            <div class="card mb-3" style="border-radius: 20px">
                                <div class="card-body">
                                    ...
                                    <form action="{{ url('create-data-pelanggan') }}" method="POST"
                                        ...
                                        <div class="row pt-2">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text"
                                                    ...
                                                    id="name" placeholder="Masukan Nama Lengkap">
                                                @error('name')
                                            ...
                                            <div class="col-sm-9">
                                                <div class="input-group has-validation">
                                                    ...
                                                    <input type="text" name="username" class="form-control"
                                                        placeholder="Masukan username" id="yourUsername" required>
                                                    @error('username')
                                        ...
                                        <div class="row pt-2">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="password" name="password" class="form-control"
                                                    placeholder="Masukan password" id="yourPassword" required>
                                                @error('password')
                                                    <div class="ivalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="row pt-2">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="email" name="email" class="form-control"
                                                    placeholder="Masukan Email" id="email" required>
                                                @error('email')
                                                    <div class="ivalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="col-12">
                                            <label class="form-label">Sudah punya akun? <a
                                                    href="{{ url('login') }}"><b>Login</b></a></label>
                                        </div>
                                    </form>
