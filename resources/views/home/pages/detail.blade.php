...
<div class="col-12 wow fadeInUp" data-wow-delay="0.1s">
    <div class="container-xxl py-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <img class="img-fluid" src="{{ url('assets/upload/images/alat_berat/' . $alat_berat->gambar) }}" alt="">
                </div>
                <div class="col-lg-6">
                    <div class="row pt-2 pb-4">
                        ...
                        <div class="col-6">
                            <div class="pt-4">
                                ...
                                <br>
                                <small>Tanggal <b>{{ $alat_berat->tgl_tersedia }}</b> Jam <b>{{ $alat_berat->jam_tersedia }}</b></small>
                                @endif
                            </div>
                        </div>
                        <div class="col-6">
                        ...
                        <div class="pt-2" id="kontrak" style="display: none;">
                            ...
                            <div class="mb-3 pt-2">
                                ...
                                <div class="row pt-2 pb-2">
                                    <label for="tgl_pemakaian" class="col-lg-4 col-sm-4 form-label fw-bold"> <i class="bi bi-calendar3"></i> Tanggal Pemakaian</label>
                                    <div class="col-lg-8 col-sm-8">
                                        <input type="datetime-local" name="tgl_pemakaian" id="tgl_pemakaian" class="form-control datetimepicker">
                                    </div>
                                </div>

                                <div class="row pt-2 pb-2">
                                    <label for="lokasi_proyek" class="col-lg-4 col-sm-4 form-label fw-bold"> <i class="bi bi-geo-alt"></i> Lokasi Proyek</label>
                                    <div class="col-lg-8 col-sm-8">
                                        <input type="text" name="lokasi_proyek" placeholder="Masukan Lokasi" id="lokasi_proyek" class="form-control">
                                    </div>
                                </div>
                                <div class="row pt-2 pb-2">
                                    <label for="durasi_kontrak" class="col-lg-4 col-sm-4 form-label fw-bold"> <i class="bi bi-hourglass-split"></i> Durasi Sewa</label>
                                    <div class="col-lg-8 col-sm-8">
                                        <div class="handle-counter" id="handleCounter" onclick="sum();">
                                            ...
                                            <span style="font-weight: bold; padding-left: 10px;">Jam</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="row pt-2 pb-2">
                                ...
                                <div class="row pt-2 pb-2">
                                    <label class="col-lg-4 col-sm-4 form-label fw-bold"> <i class="bi bi-cash"></i> Jam Selesai</label>
                                    <div class="col-lg-8 col-sm-8">
                                        <span style="font-weight: bold; font-size: x-large;"> <span id="totaldurasi">0</span></span>
                                        <input type="text" id="textdurasi" name="textdurasi" hidden>
                                    </div>
                                </div>
                                <div class=" d-flex justify-content-center">
