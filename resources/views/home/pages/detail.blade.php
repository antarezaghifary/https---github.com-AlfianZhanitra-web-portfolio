                            ...
                            <div class="mb-3 pt-2">
                                ...
                                <div class="row pt-2 pb-2">
                                    ...
                                    <div class="col-lg-8 col-sm-8">
                                        <input type="date" name="tgl_pemakaian" id="tgl_pemakaian" class="form-control">
                                    </div>
                                </div>
                                <div class="row pt-2 pb-2">
                                ...
                                <div class="row pt-2 pb-2">
                                    <label class="col-lg-4 col-sm-4 form-label fw-bold"> <i
                                            class="bi bi-"></i> Durasi Sewa</label>
                                    <div class="col-lg-8 col-sm-8">
